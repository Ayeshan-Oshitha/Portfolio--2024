...
export const WEB_TESTOMONIALS = [
    {
        ...
        review:"OMG!! Everything about my experience with Ayeshan was exceptional. 😊 As a first-time author, I needed patience and a lot of hand-holding, and Ayeshan's brand alignment and attention to detail truly EXCEEDED my expectations. Their quick responsiveness and proactive communication made the process smooth and enjoyable—I'm so thankful and might write another book just to work with them again!"
    },
    {
        image : fiverrimg,
        name : "muka_portraits",
        ...
        review:"I am so blown away by this entire process with Ayeshan. They were so patient and so helpful all the way through this process. Going the extra mile at extra step. I will definitely be using them again for my next project. Could not recommend them more highly."
    },
    {
        image : fiverrimg,
        name : "nathalieann311",
        country : "USA",
        projectType:"Book Interior Design",
        review:"I am very impressed with the work provided. The creativity regarding the book design was beyond my expectations, the formatting was perfect and the level of professionalism was outstanding. I look forward to our next project."
    },
    {
        image : fiverrimg,
        name : "liam_langan",
    ...
    },
    {
        ...
        country : "Canada",
        projectType:"Book Interior Design",
        review:"I enjoyed working on this project. Joshua is an awesome client to work with, and I hope to collaborate on a long-term project in the future as well. Thanks!"
    },
    {
        image : fiverrimg,
        name : "freespine",
        country : "Canada",
        projectType:"Book Interior Design",
        review:"It was a fantastic working with ayeshan_27 to complete my book design. Ayeshan communicated regularly, asking all the right questions, to make sure the design was what exactly what I was looking for. The book was completed on time and I am so pleased with this end product."
    },
    {
        image : upworkimg,
        name : "Sidra Nadeem",
