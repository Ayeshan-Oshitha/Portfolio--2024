          ...
          {isSubmitted ? (
            ...
            <form className='flex flex-col gap-y-6 lg:gap-y-10' onSubmit={handleSubmit}>
              <div className='flex flex-col lg:flex-row gap-y-6 lg:gap-10'>
                ...
                <div className='flex flex-col w-full lg:w-1/2'>
                  <label htmlFor="email" className='text-xl font-light tracking-wide'>Email</label>
                  <input
                    type='email'
                    id='email'
                    name='email'
              ...
              <div className='flex flex-col lg:flex-row gap-y-6 lg:gap-10'>
                <div className='flex flex-col w-full lg:w-1/2'>
                  <label htmlFor="phone" className='text-xl font-light tracking-wide'>Phone (Optional)</label>
                  <input
                    type='text'
                    id='phone'
                    name='phone'
                ...
                <div className='flex flex-col w-full lg:w-1/2'>
                  <label htmlFor="subject" className='text-xl font-light tracking-wide'>Subject</label>
                  <input
                    type='text'
                    id='subject'
                    name='subject'
              ...
              <div className='flex flex-col w-full'>
                <label htmlFor="message" className='text-xl font-light tracking-wide'>Message</label>
                <textarea
                  id='message'
                  name='message'
