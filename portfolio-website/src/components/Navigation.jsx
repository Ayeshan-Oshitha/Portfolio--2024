  ...
  return (
    ...
    >
      ...
      <div className=" col-span-4 lg:col-span-7 justify-center items-center gap-7 text-lg hidden lg:flex order-3 lg:order-2  ">
        ...
        <NavLink to="/webProjects" className="hover:text-purple-400">
          Projects
        </NavLink>
        ...
        >
          ...
          {isDropdownOpen && (
            ...
            >
              <NavLink to="/articles" className="hover:text-purple-400">
                Articles
              </NavLink>
              <NavLink to="/graphicProjects" className="hover:text-purple-400">
                Graphic Projects
              </NavLink>
              <NavLink to="/webTestimonials" className="hover:text-purple-400">
                Full Stack Reviews
              </NavLink>
              <NavLink to="/graphicTestimonials" className="hover:text-purple-400">
      ...
      {isMobileMenuOpen && (
        ...
        >
          <NavLink to="/" className=" hover:text-purple-400  " onClick={toggleMobileMenu}>
            Home
          </NavLink>
          ...
          <NavLink to="/contact" className=" hover:text-purple-400" onClick={toggleMobileMenu}>
            Contact
          </NavLink>
          <NavLink to="/articles" className=" hover:text-purple-400" onClick={toggleMobileMenu}>
            Articles
          </NavLink>
          <NavLink to="/graphicProjects" className=" hover:text-purple-400" onClick={toggleMobileMenu}>
            Graphic Projects
          </NavLink>
          <NavLink to="/webTestimonials" className=" hover:text-purple-400" onClick={toggleMobileMenu}>
            Web Design Reviews
          </NavLink>
          <NavLink to="/graphicTestimonials" className=" hover:text-purple-400" onClick={toggleMobileMenu}>
            Graphic Design Reviews
          </NavLink>
        </div>
      )}
      ...
      {/* Chat Section */}
      <div
        className="col-span-7 lg:col-span-3 justify-center items-center flex flex-row order-2 lg:order-3 cursor-pointer"
