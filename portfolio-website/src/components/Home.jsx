    ...
    <>
      ...
      <div className="grid lg:grid-cols-12 lg:grid-rows-4 gap-7 min-h-12 lg:h-[800px] mb-7 ">
        ...
        >
          ...
          <button className="bg-[var(--lightPurple)]  tracking-wide py-3 px-3 mt-12   rounded-lg text-xl font-normal hover:bg-[var(--secondaryPurple)]">
            Ayeshan Oshitha
          </button>
          <NavLink
            to="/about"
            className="flex flex-row items-center lg:px-6 mt-12 mb-2 lg:mb-0 justify-between w-full hover:text-purple-400 transform transition-transform duration-500 hover:scale-105"
          >
        ...
        >
          ...
          <NavLink
            to="/services"
            className="flex flex-row items-center mt-8 mb-2 lg:mt-0 lg:mb-2 justify-between w-full hover:text-purple-400 transform transition-transform duration-500 hover:scale-105"
          >
        ...
        >
          ...
          <NavLink
            to="/articles"
            className="flex flex-row items-center  mt-10  justify-between w-full hover:text-purple-400 transform transition-transform duration-300 hover:scale-105"
          >
      ...
      <div className="grid lg:grid-cols-12 lg:grid-rows-3 gap-7 min-h-12 lg:h-[500px] mb-40 ">
        ...
        >
          ...
          <img
            src={webImage}
            className=" w-80  rounded-xl mt-10 object-cover transition-transform duration-300 hover:scale-105"
          />
          <NavLink
            to="/webProjects"
            className="flex flex-row items-center mt-6  mb-2 lg:mt-14 lg:mb-2 justify-between w-full hover:text-purple-400 transform transition-transform duration-500 hover:scale-105"
          >
        ...
        >
          ...
          <img
            src={graphicImage}
            className=" w-80 lg:w-80 lg:h-72  rounded-xl mt-6 object-cover transform transition-transform duration-300 hover:scale-105"
          />
          <NavLink
            to="/graphicProjects"
            className="flex flex-row items-center mt-6  mb-6 lg:mt-3 lg:mb-2 justify-between w-full hover:text-purple-400 transform transition-transform duration-500 hover:scale-105"
          >
        ...
        >
          ...
          <NavLink
            to="/webTestimonials"
            className="flex flex-row items-center  mb-6 mt-4 lg:mt-0 lg:mb-2 justify-between w-full hover:text-purple-400 transform transition-transform duration-500 hover:scale-105"
          >
        ...
        >
          <div className=" flex flex-row justify-between  items-end w-full h-full pb-5">
            <p className=" text-5xl md:text-6xl lg:text-6xl  xl:text-7xl">
              Let's Work <span className="text-purple-600">together</span>
            </p>
            <NavLink
              to="/contact"
              className="  hover:text-purple-400 transform transition-transform duration-500 hover:scale-105"
            >
              <LiaArrowCircleRightSolid className="text-3xl " />
            </NavLink>
          </div>
